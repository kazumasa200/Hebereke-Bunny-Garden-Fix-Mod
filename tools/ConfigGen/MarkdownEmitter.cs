...
public static class MarkdownEmitter
{
    public static string Emit(List<SectionDef> sections)
    {
        ...
        sb.AppendLine("<!-- This file is auto-generated by ConfigGen from HeberekeBunnyGardenMod/Configs.yaml. Do not edit manually. -->");
        sb.AppendLine();
        sb.AppendLine("# Config 設定一覧");
        sb.AppendLine();
        sb.AppendLine("ゲームを一度起動すると `BepInEx/config/net.noeleve.HeberekeBunnyGardenMod.cfg` が生成されます。");
