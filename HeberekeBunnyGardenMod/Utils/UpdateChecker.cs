...
{
    private const string ApiUrl = "https://api.github.com/repos/kazumasa200/HeberekeBunnyGardenMod/releases/latest";
    private const string ReleasesUrl = "https://github.com/kazumasa200/HeberekeBunnyGardenMod/releases/latest";
    private const int TimeoutSec = 10;

    public static IEnumerator Check()
    {
        var req = UnityWebRequest.Get(ApiUrl);
        req.SetRequestHeader("User-Agent", $"HeberekeBunnyGardenMod/{MyPluginInfo.PLUGIN_VERSION}");
